 ...
 * setters/getters are available in corresponding Hit specific request objects (like {@link EventHit} or
 * {@link PageViewHit} etc)
 *
...
public class GoogleAnalyticsRequest<T> {
    ...
    /**
     * Sets the String value for specified parameter. If value is null, the parameter is removed from the parameters
     * list.
     *
     * @param parameter
     * @param value
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>Sports</code><br>
     * Example usage: <code>cd[1-9][0-9]*=Sports</code> </div> </div>
     */
     ...
     * </p>
     * <p>
     * Each custom metric has an associated index. There is a maximum of 20 custom metrics (200 for Premium accounts).
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>47</code><br>
     * Example usage: <code>cm[1-9][0-9]*=47</code> </div> </div>
     */
     ...
     * Example usage: <code>v=1</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>UA-XXXX-Y</code><br>
     * Example usage: <code>tid=UA-XXXX-Y</code> </div> </div>
     */
     ...
     * </table>
     * <div> Example value: <code>1</code><br>
     * Example usage: <code>aip=1</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>web</code><br>
     ...
     * Example usage: <code>ds=crm</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>560</code><br>
     * Example usage: <code>qt=560</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>289372387623</code><br>
     * Example usage: <code>z=289372387623</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>35009a79-1a05-49d7-b876-2b884d0f825b</code><br>
     * Example usage: <code>cid=35009a79-1a05-49d7-b876-2b884d0f825b</code> </div> </div>
     */
    ...
    /**
     * <div class="ind"> <strong> Optional. </strong>
     * <p>
     * This is intended to be a known identifier for a user provided by the site owner/tracking library user. It may not
     * itself be PII. The value should never be persisted in GA cookies or other Analytics provided storage.
     * </p>
     * <table>
     * <tbody>
     * <tr>
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>start</code><br>
     * Example usage: <code>sc=start</code> </div> <br>
     * <div> Example value: <code>end</code><br>
     * Example usage: <code>sc=end</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>http://example.com</code><br>
     * Example usage: <code>dr=http%3A%2F%2Fexample.com</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>(direct)</code><br>
     * Example usage: <code>cn=%28direct%29</code> </div> </div>
     */
     ...
     * </table>
     * <div> Example value: <code>(direct)</code><br>
     * Example usage: <code>cs=%28direct%29</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>organic</code><br>
     * Example usage: <code>cm=organic</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>Blue Shoes</code><br>
     * Example usage: <code>ck=Blue%20Shoes</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>content</code><br>
     * Example usage: <code>cc=content</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>ID</code><br>
     * Example usage: <code>ci=ID</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>CL6Q-OXyqKUCFcgK2goddQuoHg</code><br>
     * Example usage: <code>gclid=CL6Q-OXyqKUCFcgK2goddQuoHg</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>d_click_id</code><br>
     * Example usage: <code>dclid=d_click_id</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>800x600</code><br>
     * Example usage: <code>sr=800x600</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>123x456</code><br>
     * Example usage: <code>vp=123x456</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>UTF-8</code><br>
     * Example usage: <code>de=UTF-8</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>24-bits</code><br>
     * Example usage: <code>sd=24-bits</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>en-us</code><br>
     * Example usage: <code>ul=en-us</code> </div> </div>
     */
     ...
     * </table>
     * <div> Example value: <code>1</code><br>
     * Example usage: <code>je=1</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>10 1 r103</code><br>
     * Example usage: <code>fl=10%201%20r103</code> </div> </div>
     */
     ...
     * </p>
     * <p>
     * The type of hit. Must be one of 'pageview', 'appview', 'event', 'transaction', 'item', 'social', 'exception',
     * 'timing'.
     * </p>
     * <table border="1">
     * <tbody>
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>pageview</code><br>
     * Example usage: <code>t=pageview</code> </div> </div>
     */
     ...
     * </table>
     * <div> Example value: <code>1</code><br>
     * Example usage: <code>ni=1</code> </div> </div>
     */
     ...
     * &amp;dh and &amp;dp parameters to override the hostname and path + query portions of the document location,
     * accordingly. The JavaScript clients determine this parameter using the concatenation of the
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>http://foo.com/home?a=b</code><br>
     * Example usage: <code>dl=http%3A%2F%2Ffoo.com%2Fhome%3Fa%3Db</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>foo.com</code><br>
     * Example usage: <code>dh=foo.com</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>/foo</code><br>
     * Example usage: <code>dp=%2Ffoo</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>Settings</code><br>
     * Example usage: <code>dt=Settings</code> </div> </div>
     */
     ...
     * </p>
     * <p>
     * If not specified, this will default to the unique URL of the page by either using the &amp;dl parameter as-is or
     * assembling it from &amp;dh and &amp;dp. App tracking makes use of this for the 'Screen Name' of the appview hit.
     * </p>
     * <table border="1">
     * <tbody>
     * <tr>
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>High Scores</code><br>
     * Example usage: <code>cd=High%20Scores</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>My App</code><br>
     * Example usage: <code>an=My%20App</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>com.platform.vending</code><br>
     * Example usage: <code>aiid=com.platform.vending</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>1.2</code><br>
     * Example usage: <code>av=1.2</code> </div> </div>
     */
     ...
     * </tbody>
     * </table>
     * <div> Example value: <code>com.company.app</code><br>
     * Example usage: <code>aid=com.company.app</code> </div> </div>
     */
    ...
    /**
     * IP Override parameter: uip Should be a valid IP address. This will always be anonymized just as though &aip
     * (anonymize IP) had been used. example: &uip=1.2.3.4
     */
    ...
    /**
     * User Agent Override parameter: &ua Should be a User Agent reported by the browser. Note: We have libraries to
     * identify real user agents. Hand crafting your own agent could break at any time. example:
     * &ua=Opera%2F9.80%20(Windows%20NT%206.0)%20Presto%2F2.12.388%20Version%2F12.14
     */
    ...
    /**
     * GeoId Override parameter: geoid The geographical ID should be a two letter country code or a criteria ID
     * representing a city or region example: geoid=US
     */
