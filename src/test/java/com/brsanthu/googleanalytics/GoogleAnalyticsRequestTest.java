...
public class GoogleAnalyticsRequestTest {
	...
	public void testRequestSetterGetter() throws Exception {
		...
		assertEquals("Opera/9.80 (Windows NT 6.0) Presto/2.12.388 Version/12.14", request.userAgent("Opera/9.80 (Windows NT 6.0) Presto/2.12.388 Version/12.14").userAgent());
	}
